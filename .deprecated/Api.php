 ...
 */
class Api {
	const BASE_URL         = 'https://api.carouselslider.com/v1';
	const PRIVACY_URL      = 'https://carouselslider.com/privacy-policy';
	const GO_PRO_URL       = 'https://carouselslider.com/?utm_source=wp-menu&utm_campaign=gopro&utm_medium=wp-dash';
	const PRO_SUPPORT_URL  = 'https://carouselslider.com/?utm_source=wp-menu&utm_campaign=pro-support&utm_medium=wp-dash';
